    ...
    <main className="p-6 max-w-4xl mx-auto bg-gradient-to-br from-blue-50 to-white min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {greenhouses.map((house) => (
          <div key={house.id} className="border border-blue-200 p-4 rounded shadow bg-white hover:shadow-md transition">
            <img src={house.image} alt={house.name} className="w-full h-48 object-cover rounded mb-4" />
